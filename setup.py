    ...
    if 'fasttransformer_moe_sparse_gemm' in features:
        ...
        ext_modules.append(cpp_extension.CUDAExtension(
                ...
                sources=[
                    ...
                    f"{project_name}/cuda_kernels/FasterTransformer/th_moe_ops.cu",
                    f"{project_name}/cuda_kernels/FasterTransformer/logger.cu",
                    f"{project_name}/cuda_kernels/FasterTransformer/moe_kernels.cu",
                    f"{project_name}/cuda_kernels/FasterTransformer/cutlass_preprocessors.cu",
                ],
